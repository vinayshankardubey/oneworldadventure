											...
											<div class="card-body pb-2 loadmore-content" id="BookingContent">
												...
												<div class="rooms mt-3 d-flex align-items-center justify-content-between flex-wrap">
													<div class="d-flex align-items-center mb-3">
														<img src="{{asset('admin_assets/images/room/room1.jpg')}}" alt="">
														<div class="ms-4 bed-text">
															<h4>Queen Bed A-12324</h4>
															<div class="users d-flex align-items-center">
																<img src="{{asset('admin_aseets/images/users/user1.jpg')}}" alt="">
																<div>
												...
												<div class="rooms mt-3 d-flex align-items-center justify-content-between flex-wrap">
													<div class="d-flex align-items-center mb-3">
														...
														<div class="ms-4 bed-text">
															...
															<div class="users d-flex align-items-center">
																<img src="{{asset('admin_assets/images/users/user2.jpg')}}" alt="">
																<div>
										...
										<div class="front-view-slider owl-carousel owl-carousel owl-loaded owl-drag owl-dot">
											<div class="items">
												<div class="customers border">
													...
													<div class="d-flex justify-content-between align-items-center mt-4">
														...
														<img src="{{asset('admin_assets/images/users/user5.jpg')}}" alt="">
														<div class="ms-3">
											...
											<div class="items">
												<div class="customers border">
													...
													<div class="d-flex justify-content-between align-items-center mt-4">
														<div class="customer-profile d-flex ">
														<img src="{{asset('admin_assets/images/users/user6.jpg')}}" alt="">
														<div class="ms-3">
															<h5 class="mb-0"><a href="javascript:void(0);">Kusnaidi Anderson</a></h5>
															<span>4m ago</span>
														</div>
											...
											<div class="items">
												<div class="customers border">
													...
													<div class="d-flex justify-content-between align-items-center mt-4">
														<div class="customer-profile d-flex ">
														<img src="{{asset('admin_assets/images/users/user7.jpg')}}" alt="">
														<div class="ms-3">
															<h5 class="mb-0"><a href="javascript:void(0);">Kusnaidi Anderson</a></h5>
															<span>4m ago</span>
														</div>
