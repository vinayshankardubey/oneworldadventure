<footer class="footer -type-1 -round">
      <div class="footer__main">
        <div class="footer__bg bg-accent-1-05 rounded-24"></div>
          ...
          <div class="row y-gap-5 justify-between items-center">
            ...
            <div class="col-auto">
              <div class="footer__images d-flex items-center x-gap-10">
                <img src="{{asset('front_assets/img/footer/cards/1.png')}}" alt="image">
                <img src="{{asset('front_assets/img/footer/cards/2.png')}}" alt="image">
                <img src="{{asset('front_assets/img/footer/cards/3.png')}}" alt="image">
                <img src="{{asset('front_assets/img/footer/cards/4.png')}}" alt="image">
                <img src="{{asset('front_assets/img/footer/cards/5.png')}}" alt="image">
                <img src="{{asset('front_assets/img/footer/cards/6.png')}}" alt="image">
              </div>
            </div>
          </div>
        </div>
  ...
  <script src="{{asset('front_assets/js/vendors.js')}}"></script>
